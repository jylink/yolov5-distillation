        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                if opt.t_weights:
                    with torch.no_grad():
                        t_pred = t_model(imgs) 
                    kd_loss, kd_loss_items = compute_loss.kd_loss(pred, t_pred)
                    loss += kd_loss
                if rank != -1:
            ...
            if rank in [-1, 0]:
                ...
                if opt.t_weights: kd_mloss = (kd_mloss * i + kd_loss_items) / (i + 1)
...
if __name__ == '__main__':
    ...
    # KD
    parser.add_argument('--t_weights', default='', help='teacher model')
    parser.add_argument('--kd_factor', type=float, default=1.0, help='factor of kd loss')
